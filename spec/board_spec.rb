...
describe Board do 
  ...
  describe '#winning_horizontal?' do 
  	it 'To see if the winning condition for horizontal returns true' do
  		b.board[0][0]="X"
  		b.board[1][0]="X"
  		b.board[2][0]="X"
  		b.board[3][0]="X"
  	...
  	it 'To see if the winning condition for horizontal returns false' do
  		b.board[0][0]="z"
  		b.board[1][0]="z"
  		b.board[2][0]="z"
  		b.board[3][0]="z"
  ...
  describe '#winning_diagonal?' do 
  	it 'To see if the winning condition for diag returns true' do
  		b.board[0][0]="X"
  		b.board[1][1]="X"
  		b.board[2][2]="X"
  		b.board[3][3]="X"
